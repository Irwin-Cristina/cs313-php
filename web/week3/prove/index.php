...
if (isset($_GET["product"]) && isset($_GET["price"])) {
    ...
    if (!in_array($product_name, $_SESSION["product"])) { 
        array_push($_SESSION["product"], $product_name); //$_SESSION =>(array(cover your assets))
    }
...
<body>
    <header>
        ...
        <div id='nav'>
            ...
            <a href='checkout.php' id="<?php echo ($active==="CHECKOUT" ? "active_link" : "non_active_link") ?>">CHECKOUT</a>
        </div>
    </header>
   <?php 
