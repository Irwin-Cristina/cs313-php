            ...
            <form method ="post" action="cartresults.php">
                <div class="wrapper">
                    <div class="game">
                        ...
                        <input type="checkbox" name="game[]" value="Cover your Assets">
                    </div>
                    ...
                    <div class="game">
                        ...
                        <input type="checkbox" name="game[]" value="Exploding Kittens">
                    </div>
                    ...
                    <div class="game">
                        ...
                        <input type="checkbox" name="game[]" value="Factions">
                    </div>
                    ...
                    <div class="game">
                        ...
                        <input type="checkbox" name="game[]" value="Game of Phones">
                    </div>
                     ...
                     <div class="game">
                        ...
                        <img src="images/qwixx.jpg" alt="qwixx">
                         ...
                         <input type="checkbox" name="game[]" value="Qwixx">
                    </div>
                    ...
                    <div class="game">
                        ...
                        <input type="checkbox" name="game[]" value="Tenzi">
                    </div>
                </div>
